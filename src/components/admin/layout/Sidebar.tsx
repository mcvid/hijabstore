...
export default function Sidebar({ isOpen, onClose }: SidebarProps) {
    ...
    return (
        <aside
            className={`fixed lg:static inset-y-0 left-0 z-50 w-64 bg-[#0a0e14] text-white transition-all duration-300 transform ${isOpen ? "translate-x-0" : "-translate-x-full lg:translate-x-0 lg:w-20"
                }`}
        >
